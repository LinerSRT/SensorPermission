...
public class PM {
    ...
    public static void init(String preferenceName) {
        ...
        if (PM.sharedPreferences == null) {
            PM.sharedPreferences = new RemotePreferences(AndroidAppHelper.currentApplication(), "ru.liner.sensorpermission", preferenceName.replace(".xml", ""));
        }
    }
    ...
    public static void init(Context context, String preferenceName) {
        PM = new PM();
        if (PM.sharedPreferences == null) {
            PM.sharedPreferences = new RemotePreferences(context, "ru.liner.sensorpermission", preferenceName.replace(".xml", ""));
        }
    }
    public static void init(Context context) {
        PM = new PM();
        if (PM.sharedPreferences == null) {
            PM.sharedPreferences = new RemotePreferences(context, "ru.liner.sensorpermission", "sensorpermission");
        }
    }

    public static void init() {
        init("sensorpermission");
    }
