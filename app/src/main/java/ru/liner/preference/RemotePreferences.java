 ...
 */
public class RemotePreferences implements IPreference {
    private final com.crossbowffs.remotepreferences.RemotePreferences preferences;

    public RemotePreferences(@NonNull Context context, @NonNull String preferenceName) {
        this.preferences = new com.crossbowffs.remotepreferences.RemotePreferences(context, BuildConfig.APPLICATION_ID, preferenceName);
    }
